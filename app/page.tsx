      ...
      <header className="border-b border-gray-200 bg-white/90 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <button
            ...
            className="hidden md:inline-block bg-green-600 hover:bg-green-700 hover:scale-105 active:scale-95 text-white px-6 py-3 rounded-2xl font-medium transition duration-300"
          >
            Заказать
          </button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <div className="flex flex-col sm:flex-row gap-5 mb-14">
                ...
                <Link
                  href="/services"
                  className="border-2 border-slate-900 hover:bg-slate-900 hover:text-white hover:scale-105 active:scale-95 px-8 py-5 rounded-2xl text-lg font-semibold transition text-center"
                >
                  Смотреть услуги
                </Link>
              </div>
